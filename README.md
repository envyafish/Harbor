...
| 平台 | 说明 |
|------|------|
| macOS 26+（仅 Apple Silicon） | Overlay 标题栏；原生播放随应用分发 |
| Windows 10+（x64） | 无边框窗口；原生播放随应用分发 |

当前安装程序仅支持 **Windows 10**（x64）与 **macOS 26** 及以上（仅 Apple Silicon）。
...
- 可访问的 Emby 服务器
- Windows 10+（x64），或 macOS 26+（仅 Apple Silicon）
...
如果 Harbor 对你有帮助，欢迎通过微信赞赏支持：

<img src="docs/sponsor-qr.png" alt="微信赞赏码" width="220" />
